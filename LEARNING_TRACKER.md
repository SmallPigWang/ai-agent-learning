...
阶段 7: 元能力          [░░░░░░░░░░░░░░░░░░░░]   0%  (持续)
──────────────────────────────────────────────────────────
总体进度               [███████░░░░░░░░░░░░░]  38%  (条目口径, 与 check_progress.py 一致)
```
...
- [ ] Agent 有记忆、能规划、会反思
- [ ] Agent 有基本安全防护
- [ ] 🎯 北极星: StudyNote Agent 雏形跑通（读 logs 目录 + 回答问题）
- [ ] 📊 验收: 通过 STUDYNOTE_EVAL 评估集（总分 ≥ 16/20）📎 `studynote_eval.md`
...
| M5 🟣 | 2 进行中 | StudyNote Agent 雏形 + 有记忆 | ___ | ⬜ |
