...
| 9 | 09-06 | 08:45-14:39 | **阶段2验收20/20 🏆 + 3.1/3.2/3.3 三连封（RAG 北极星换芯）** + 音频支线 | [📝](logs/day-09.md) |
| 🔄 | — | — | 复习日（每 5 个学习日 1 次） | — |

**下一目标**: 3.3 EVAL 复测（配额恢复）→ 3.4 检索策略进阶
...
- [x] 🔄 回头补 2.3: 用 Embedding 给 StudyNote Agent 升级向量长期记忆 📎 `studynote_rag.py`（EVAL 复测待配额恢复）
